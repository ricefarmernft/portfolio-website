      ...
      <div className="container crypto">
        <div className="crypto-text">
          <p>
            ...
            contracts, and NFTs. On Twitter, he is a content creator and has
            amassed over 20k+ followers. He is also apart of numerous NFT
            communities and enjoys marketing and community building.
          </p>
        </div>
